...
class Cent6Conflicts(db1.Model):
    ...
    __bind_key__ = 'cent6'
    rpm_id = db1.Column(db1.Integer,
                        db1.ForeignKey('Packages.rpm_id'),
...
class Cent6Packages(db1.Model):
    ...
    Size = db1.Column(db1.Integer, nullable=False)
    changelog = db1.relationship('Cent6ChangeLogs',
                                backref='package',
                                lazy='dynamic')
    conflicts = db1.relationship('Cent6Conflicts',
                                backref='package',
                                lazy='dynamic')
    distributions = db1.relationship('Cent6Distribution',
                                    backref='package',
                                    lazy='dynamic')
    files = db1.relationship('Cent6Files',
                            backref='package',
                            lazy='dynamic')
    obsoletes = db1.relationship('Cent6Obsoletes',
                                backref='package',
                                lazy='dynamic')
    provides = db1.relationship('Cent6Provides',
                                backref='package',
                                lazy='dynamic')
    requires = db1.relationship('Cent6Requires',
                                backref='package',
                                lazy='dynamic')
    softwarechangelogs = db1.relationship('Cent6SoftwareChangeLogs',
                                        backref='package',
                                        uselist=False)
    specchangelogs = db1.relationship('Cent6SpecChangeLogs',
                                    order_by="Cent6SpecChangeLogs.ID",
                                    backref='package',
                                    lazy='dynamic')
...
class Cent6SoftwareChangeLogs(db1.Model):
    ...
    __bind_key__ = 'cent6'
    build_id = db1.Column(db1.Integer,
                            db1.ForeignKey('Packages.build_id'),
                            nullable=False, primary_key=True, default=0)
...
class Cent5Conflicts(db2.Model):
    __tablename__ = 'Conflicts'
    __bind_key__ = 'cent5'
    rpm_id = db2.Column(db2.Integer,
                        db2.ForeignKey('Packages.rpm_id'),
                        nullable=False, primary_key=True, default=0)
...
class Cent5Packages(db2.Model):
    ...
    Size = db2.Column(db2.Integer, nullable=False)
    changelog = db2.relationship('Cent5ChangeLogs',
                                backref='package',
                                lazy='dynamic')
    conflicts = db2.relationship('Cent5Conflicts',
                                backref='package',
                                lazy='dynamic')
    distributions = db2.relationship('Cent5Distribution',
                                    backref='package',
                                    lazy='dynamic')
    files = db2.relationship('Cent5Files',
                            backref='package',
                            lazy='dynamic')
    obsoletes = db2.relationship('Cent5Obsoletes',
                                backref='package',
                                lazy='dynamic')
    provides = db2.relationship('Cent5Provides',
                                backref='package',
                                lazy='dynamic')
    requires = db2.relationship('Cent5Requires',
                                backref='package',
                                lazy='dynamic')
    softwarechangelogs = db2.relationship('Cent5SoftwareChangeLogs',
                                        backref='package',
                                        uselist=False)
    specchangelogs = db2.relationship('Cent5SpecChangeLogs',
                                    order_by="Cent5SpecChangeLogs.ID",
                                    backref='package',
                                    lazy='dynamic')
...
class Cent5SoftwareChangeLogs(db2.Model):
    ...
    __bind_key__ = 'cent5'
    build_id = db2.Column(db2.Integer,
                        db2.ForeignKey('Packages.build_id'),
                        nullable=False, primary_key=True, default=0)
